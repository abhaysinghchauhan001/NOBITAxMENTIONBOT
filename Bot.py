...
# Rocks © @NOBITA_BOT © NOBITA
# Owner NOBITA + NOBITA_BOT + NOBITA_WORLD 
...
async def help(event):
    ...
    await event.reply(
        ...
        buttons=(
            [
                Button.url("❤️‍🔥 ꜱᴜᴘᴘᴏʀᴛ 💫", "https://t.me/+sIl5s2_0xvAyMjhl"),
                Button.url("❤️‍🔥 ᴜᴘᴅᴀᴛᴇ 💫", "https://t.me/NOBITA_MUSIC_SUPPORT"),
            ]
        ),
    )
...
async def help(event):
    ...
    if not event.is_private:
        return await event.respond("ᴅᴇᴀʀ sᴛᴀʀᴛ ᴍᴇ ɪɴ ᴘᴍ ᴛᴏ ᴜsᴇ ᴛʜɪs ᴄᴏᴍᴍᴀɴғ 🥺")
    helptext = "✪ ᴏᴡɴᴇʀ ᴍᴇɴᴜ ᴏғ ᴀʟᴇxᴀ ᴍᴇɴᴛɪᴏɴ\n\n✪ ᴍʏ ᴏᴡɴᴇʀ ɪs [ɴᴏʙɪᴛᴀ ʙᴏᴛ](https://t.me/ll_YOURR_NOBITA_ll)\n✪ ᴏғғɪᴄɪᴀʟ ᴍᴇᴍʙᴇʀ ᴏғ ɴᴏʙɪᴛᴀ\n✪ ᴜᴘᴅᴀᴛᴇ [ᴄʜᴀɴɴᴇʟ](https://t.me/NOBITA_MUSIC_SUPPORT)\n✪ ғᴜᴛᴜʀᴇ ᴀɴᴇsᴛʜᴇᴛɪᴄ."
    await event.reply(
        helptext,
        link_preview=False,
        buttons=(
...
# Property Of Branded Indian Largest Support Group
# Rocks © @NOBITA_BOT © NOBITA
# Owner NOBITA + NOBITA_BOT + NOBITA_WORLD + NOBITA SUPPORT CHAT 
